...
TC-00001 ADD FIRST 5 USERS AND VERIFY TABLE DISPLAY
    [Documentation]    Add first 5 users and Verify table display
    Login Customer
    Sleep    3s
...
TC-00002 UPDATE EXISTING CUSTOMERS
    [Documentation]    Update existing customers
    Update User In Table
    
TC-00003 LOG TABLE DATA
    [Documentation]    Log table data
    Log Table Data

TC-00004 ANALYZE CUSTOMER SPENDING
